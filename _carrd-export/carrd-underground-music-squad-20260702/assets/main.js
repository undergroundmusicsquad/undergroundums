...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('.text-component.style-20', { style: 'fade-in', speed: 750, intensity: 0, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > *', state: true, replay: false });
		onvisible.add('.text-component.style-21', { style: 'fade-in', speed: 750, intensity: 0, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > *', state: true, replay: false });
